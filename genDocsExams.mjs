...
async function main() {
    ...
    //cdn
    let cdn = `<script src="https://cdn.jsdelivr.net/npm/w-jsonview-table@${pkg.version}/dist/w-jsonview-table.umd.js"></script>`
    ...
    _.each(ltfs, function(v) {
        ...
        //replace
        let r = `<script src="../dist/w-jsonview-table.umd.js"></script>`
        c = c.replace(r, cdn)
